...
const SectionFiltre = ({ setDataList, setDataListNeuf, data }: FiltreProps) => {
  const [yearState, setYearState] = useState<number>(new Date().getFullYear());
  ...
  const handleFilter = () => {
    setDataList(
      data.filter(
        (car) =>
          car.year === yearState ||
          car.kilometrage <= kilometrageState ||
          car.transmission === transmissionState ||
          car.category.toLocaleLowerCase() ===
            categoryState.toLocaleLowerCase() ||
          car.etat === "Occasion"
      )
    );
    ...
    <div className="flex flex-col gap-3 justify-center items-center">
      <div className="flex justify-center items-center">
        <button
          ...
          className="p-3 flex flex-row justify-center items-center gap-3 rounded-lg text-black w-44 md:w-64  hover:opacity-80 transition-all bg-slate-100 "
        >
        ...
        <div className="flex flex-col gap-3">
          <div className="grid grid-cols-1 gap-3 md:grid-cols-4">
            ...
            <select
              ...
              className="bg-slate-200 p-3"
            >
              <option value="">Select a consommation</option>
