...
export default function SectionMaps() {
  ...
  return (
    <section id="lieu" className="max-md:p-4 pt-16 flex flex-col justify-center items-center bg-white max-md:shadow-lg">
      <div className="flex flex-col justify-center items-center">
        <Image src={maps} alt="" width={32} height={32} />
      </div>
      <h1 className="font-bold text-3xl md:text-4xl text-black text-center m-3">
      <span className="text-primary-color">Où</span> nous trouvez?
      </h1> 
