...
const cars: Car[] = [
  {
    ...
    etat: "Occasion",
    images: [
      "/img/rmbg/jagar__2_-removebg-preview.png",
      "/img/jagar (1).jpg",
      "/img/jagar (2).jpg",
      "/img/jagar (3).jpg",
      "/img/jagar (4).jpg",
  ...
  },
  {
    ...
    unit: "L",
    images: [
       "/img/rmbg/ford__8_-removebg-preview.png",
       "/img/rmbg/ford__8_-removebg-preview.png",
       "/img/ford (8).jpg",
       "/img/ford (9).jpg",
    ],
  },
  {
    ...
    unit: "L",
    images: [
       "/img/rmbg/prado__2_-removebg-preview.png",
  ...
  },
  {
    ...
    unit: "L",
    images: [
      "/img/rmbg/landcruiser__2_-removebg-preview.png",
  ...
  },
  {
    ...
    unit: "L",
    images: [
      "/img/rmbg/landcruiserVan__2_-removebg-preview.png",
  ...
  },
  {
    ...
    unit: "L",
    images: [
      "/img/rmbg/lexus__2_-removebg-preview.png",
      "/img/lexus (2).jpg",
      "/img/lexus (3).jpg",
      "/img/lexus (5).jpg",
      "/img/lexus (6).jpg",
  ...
  },
  {
    ...
    unit: "L",
    images: [
      "/img/rmbg/lexusGris__8_-removebg-preview.png",
      "/img/lexusGris (2).jpg",
      "/img/lexusGris (4).jpg",
      "/img/lexusGris (5).jpg",
   ],
