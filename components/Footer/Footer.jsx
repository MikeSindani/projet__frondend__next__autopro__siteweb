      ...
      <div className="container m-auto flex flex-wrap items-start justify-between p-10">
        ...
        <div className="w-full md:w-1/4 p-2">
          <div className="flex flex-col justify-center mb-4 gap-y-2">
            <div className="text-3xl md:text-4xl text-primary-color font-extrabold font-Great-Vibes ">
              AutoPro
            </div>
            <p className="text-white text-sm">
              {" "}
              Meilleur vendeur d{"'"}auto à lubumbashi.
            </p>
          </div>
        </div>
        {/* Navigation */}
        <div className="w-full md:w-1/4 p-2">
          ...
          <ul className="list-none">
            ...
            <li className="mb-2">
              <Link href="#lieu" className="hover:text-primary-color text-gray-100 text-sm">
                  Maps
              </Link>
            </li>
            <li className="mb-2">
              <Link href="#faq" className="hover:text-primary-color text-gray-100 text-sm">
                  Question frequement posées
              </Link>
            </li>
          </ul>
        </div>
        ...
        <div className="w-full md:w-1/4 p-2">
          ...
          <ul className="list-none">
            ...
            <li className="mb-2">
              <a href="https://www.instagram.com/autoprordc?igsh=MXBzc2Frb2h6bDVnYg==" className="hover:text-red-500 text-gray-100 text-sm">
                Instagram
              </a>
            </li>
          </ul>
